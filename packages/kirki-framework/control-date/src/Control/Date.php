...
class Date extends Base {
	...
	public function enqueue() {
		...
		// Enqueue the script.
		wp_enqueue_script( 'kirki-control-date', URL::get_from_path( dirname( dirname( __DIR__ ) ) . '/dist/control.js' ), [ 'jquery', 'customize-base', 'kirki-dynamic-control', 'jquery-ui-datepicker' ], self::$control_ver, false );
