...
class Aliases {
	...
	private $aliases = [
		'generic'    => [
			...
			[ 'Kirki\Module\CSS\Field\Background', 'Kirki_Output_Field_Background' ],
			[ 'Kirki\Module\CSS\Field\Dimensions', 'Kirki_Output_Field_Dimensions' ],
			[ 'Kirki\Module\CSS\Field\Image', 'Kirki_Output_Field_Image' ],
			[ 'Kirki\Module\CSS\Field\Multicolor', 'Kirki_Output_Field_Multicolor' ],
			[ 'Kirki\Module\CSS\Field\Typography', 'Kirki_Output_Field_Typography' ],
