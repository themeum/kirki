...
class ComposerAutoloaderInitc56aa391ac498061f8d648878e0e6144
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitc56aa391ac498061f8d648878e0e6144::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirec56aa391ac498061f8d648878e0e6144($fileIdentifier, $file);
        }
...
function composerRequirec56aa391ac498061f8d648878e0e6144($fileIdentifier, $file)
{
