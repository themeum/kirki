( function( api, $ ) {
	...
	/**
	 * A dynamic select control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiSelectControl = api.Control.extend({
	...
	api.controlConstructor['kirki-select'] = api.kirkiSelectControl;
