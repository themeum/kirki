( function( api, $ ) {
	...
	/**
	 * A dynamic dimension control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiDimensionControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-dimension';
			}
	...
	api.controlConstructor['kirki-dimension'] = api.kirkiDimensionControl;
