...
class Kirki_Control_Radio_Buttonset extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-radio-buttonset', trailingslashit( Kirki::$url ) . 'controls/js/radio-buttonset.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control' ), false, true );
