...
class Kirki_Control_Dashicons extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-dynamic-control', trailingslashit( Kirki::$url ) . 'controls/js/dynamic-control.js', array( 'jquery', 'kirki-dynamic-control', 'customize-base' ), false, true );
