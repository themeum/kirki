...
class Kirki_Control_Multicolor extends WP_Customize_Control {
	...
	public function enqueue_scripts() {
		...
		$script_filename = ( Kirki_Util::get_wp_version() >= 4.9 ) ? 'multicolor.js' : 'multicolor-legacy.js';
		wp_enqueue_script( 'kirki-multicolor', trailingslashit( Kirki::$url ) . 'controls/js/' . $script_filename, array( 'jquery', 'customize-base', 'wp-color-picker-alpha' ), false, true );
