...
class Kirki_Control_Select extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'kirki-select', trailingslashit( Kirki::$url ) . 'controls/js/select.js', array( 'jquery', 'customize-base', 'kirki-dynamic-control', 'selectWoo', 'jquery-ui-sortable' ), false, true );
