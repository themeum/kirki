( function( api, $ ) {
	...
	/**
	 * A dynamic color-palette control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiColorPaletteControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-color-palette';
			}
	...
	api.controlConstructor['kirki-color-palette'] = api.kirkiColorPaletteControl;
