( function( api, $ ) {
	...
	/**
	 * A dynamic preset control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiPresetControl = api.Control.extend({
	...
	api.controlConstructor['kirki-preset'] = api.kirkiPresetControl;
