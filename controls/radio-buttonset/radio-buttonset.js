( function( api, $ ) {
	...
	/**
	 * A dynamic radio-buttonset control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiRadioButtonsetControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-radio-buttonset';
			}
	...
	api.controlConstructor['kirki-radio-buttonset'] = api.kirkiRadioButtonsetControl;
