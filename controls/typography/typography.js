( function( api, $ ) {
	...
	/**
	 * A dynamic typography control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiTypographyControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-typography';
			}
	...
	api.controlConstructor['kirki-typography'] = api.kirkiTypographyControl;
