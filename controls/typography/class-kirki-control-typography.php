...
class Kirki_Control_Typography extends WP_Customize_Control {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'kirki-typography', trailingslashit( Kirki::$url ) . 'controls/typography/' . $script_filename, array( 'jquery', 'customize-base', 'selectWoo', 'wp-color-picker-alpha' ), false, true );
