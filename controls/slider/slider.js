( function( api, $ ) {
	...
	/**
	 * A dynamic slider control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiSliderControl = api.Control.extend({
	...
	api.controlConstructor['kirki-slider'] = api.kirkiSliderControl;
