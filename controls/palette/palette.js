( function( api, $ ) {
	...
	/**
	 * A dynamic palette control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiPaletteControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-palette';
			}
	...
	api.controlConstructor['kirki-palette'] = api.kirkiPaletteControl;
