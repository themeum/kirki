( function( api, $ ) {
	...
	/**
	 * A dynamic radio-image control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiRadioImageControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-radio-image';
			}
	...
	api.controlConstructor['kirki-radio-image'] = api.kirkiRadioImageControl;
