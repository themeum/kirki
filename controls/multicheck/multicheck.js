( function( api, $ ) {
	...
	/**
	 * A dynamic multicheck control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiMultickeckControl = api.Control.extend({
		...
		initialize: function( id, options ) {
			...
			if ( ! args.params.type ) {
				args.params.type = 'kirki-multicheck';
			}
	...
	api.controlConstructor['kirki-multicheck'] = api.kirkiMultickeckControl;
