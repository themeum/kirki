( function( api, $ ) {
	...
	/**
	 * A dynamic toggle control.
	 *
	 * @class
	 * @augments wp.customize.Control
	 * @augments wp.customize.Class
	 */
	api.kirkiToggleControl = api.Control.extend({
	...
	api.controlConstructor['kirki-toggle'] = api.kirkiToggleControl;
