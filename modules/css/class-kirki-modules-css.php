...
class Kirki_Modules_CSS {
	...
	protected function __construct() {
		$class_files = array(
			...
			'Kirki_Output_Field_Slider_Advanced'        => '/field/class-kirki-output-field-slider-advanced.php',
			'Kirki_Output_Field_Spacing_Advanced'       => '/field/class-kirki-output-field-spacing-advanced.php',
			'Kirki_Output_Field_Typography'             => '/field/class-kirki-output-field-typography.php',
			'Kirki_Output_Field_Typography_Advanced'    => '/field/class-kirki-output-field-typography-advanced.php',
