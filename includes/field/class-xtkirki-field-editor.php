...
if ( ! class_exists( 'XTKirki_Field_Editor' ) ) {

	/**
	 * Field overrides.
	 */
	class XTKirki_Field_Editor extends XTKirki_Field {
		...
		public static function add_editor() {
			...
			echo '<div id="xtkirki_editor_pane" class="hide">';
			wp_editor( '', 'xtkirki-editor', array(
