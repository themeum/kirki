...
if ( ! class_exists( 'XTKirki_Field_Color' ) ) {

	/**
	 * Field overrides.
	 */
	class XTKirki_Field_Color extends XTKirki_Field {
		...
		protected function set_sanitize_callback() {
			...
			$this->sanitize_callback = array( 'XTKirki_Sanitize_Values', 'color' );
