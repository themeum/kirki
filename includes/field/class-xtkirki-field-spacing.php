...
if ( ! class_exists( 'XTKirki_Field_Spacing' ) ) {

	/**
	 * Field overrides.
	 */
	class XTKirki_Field_Spacing extends XTKirki_Field_Number {
		...
		public function sanitize( $value ) {
			...
			foreach ( $value as $key => $sub_value ) {
				$value[ $key ] = XTKirki_Sanitize_Values::css_dimension( $sub_value );
			}
			return $value;
