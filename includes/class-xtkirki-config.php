...
if ( ! class_exists( 'XTKirki_Config' ) ) {

	/**
	 * The XTKirki_Config object
	 */
	final class XTKirki_Config {
		...
		/**
		 * Set to true if you want to completely disable any XTKirki-generated CSS.
		 *
		 * @access protected
		 * @var bool
		 */
		 ...
		 * @access private
		 *
		 * @param string $id     @see XTKirki_Config::get_instance().
		 * @param array  $args   @see XTKirki_Config::get_instance().
		 */
		private function __construct( $id = 'global', $args = array() ) {
			...
			// Apply any xtkirki/config global filters.
			$defaults = apply_filters( 'xtkirki/config', $defaults );
