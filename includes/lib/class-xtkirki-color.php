<?php
/**
 * Color Calculations class for XTKirki
 * Initially built for the Shoestrap-3 theme and then tweaked for XTKirki.
 *
 * @package     XTKirki
 * @category    Core
...
if ( ! class_exists( 'XTKirki_Color' ) ) {

	/**
	 * Helper class for color manipulation.
	 */
	final class XTKirki_Color extends ariColor {
