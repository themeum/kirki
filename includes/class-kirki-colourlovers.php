...
class Kirki_Colourlovers {
	...
	public static function order_by( $palette = array(), $order = 'none' ) {
		...
		if ( 'none' == $order ) {
			...
			$colors_array_1b = Kirki_Helper::array_delete( $brightest_0_key, $colors_array_0b );
			...
			$colors_array_2b = Kirki_Helper::array_delete( $brightest_1_key, $colors_array_1b );
			...
			$colors_array_3b = Kirki_Helper::array_delete( $brightest_2_key, $colors_array_2b );
			...
			$colors_array_4b = Kirki_Helper::array_delete( $brightest_3_key, $colors_array_3b );
			...
			$colors_array_1s      = Kirki_Helper::array_delete( $most_saturated_0_key, $colors_array_0s );
			...
			$colors_array_2s      = Kirki_Helper::array_delete( $most_saturated_1_key, $colors_array_1s );
			...
			$colors_array_3s      = Kirki_Helper::array_delete( $most_saturated_2_key, $colors_array_2s );
			...
			$colors_array_4s      = Kirki_Helper::array_delete( $most_saturated_3_key, $colors_array_3s );
			...
			$colors_array_1i    = Kirki_Helper::array_delete( $most_intense_0_key, $colors_array_0i );
			...
			$colors_array_2i    = Kirki_Helper::array_delete( $most_intense_1_key, $colors_array_1i );
			...
			$colors_array_3i    = Kirki_Helper::array_delete( $most_intense_2_key, $colors_array_2i );
			...
			$colors_array_4i    = Kirki_Helper::array_delete( $most_intense_3_key, $colors_array_3i );
			...
			$colors_array_1d   = Kirki_Helper::array_delete( $bright_dull_0_key, $colors_array_0d );
			...
			$colors_array_2d   = Kirki_Helper::array_delete( $bright_dull_1_key, $colors_array_1d );
			...
			$colors_array_3d   = Kirki_Helper::array_delete( $bright_dull_2_key, $colors_array_2d );
			...
			$colors_array_4d   = Kirki_Helper::array_delete( $bright_dull_3_key, $colors_array_3d );
