...
if ( ! class_exists( 'XTKirki_Fonts' ) ) {

	/**
	 * The XTKirki_Fonts object.
	 */
	final class XTKirki_Fonts {
		...
		public static function get_all_fonts() {
			...
			return apply_filters( 'xtkirki/fonts/all', array_merge( $standard_fonts, $google_fonts ) );
		}
		 ...
		 */
		 public static function get_standard_fonts() {
			...
			return apply_filters( 'xtkirki/fonts/standard_fonts', $standard_fonts );
		}
		...
		public static function get_backup_fonts() {
			...
			return apply_filters( 'xtkirki/fonts/backup_fonts', $backup_fonts );
		}
		...
		public static function get_google_fonts() {
			...
			if ( null === self::$google_fonts || empty( self::$google_fonts ) ) {
				...
				$fonts = include wp_normalize_path( XTKirki::$path . '/includes/webfonts.php' );
				...
				self::$google_fonts = apply_filters( 'xtkirki/fonts/google_fonts', $google_fonts );
