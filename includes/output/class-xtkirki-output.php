...
if ( ! class_exists( 'XTKirki_Output' ) ) {

	/**
	 * Handles field CSS output.
	 */
	class XTKirki_Output {

		/**
		 * The XTKirki configuration used in the field.
		 *
		 * @access protected
		 * @var string
		 */
		...
		protected function process_property_value( $property, $value ) {
			$properties = apply_filters( 'xtkirki/' . $this->config_id . '/output/property-classnames', array(
				'font-family'         => 'XTKirki_Output_Property_Font_Family',
				'background-image'    => 'XTKirki_Output_Property_Background_Image',
				'background-position' => 'XTKirki_Output_Property_Background_Position',
			) );
