<?php
/**
 * The XTKirki API class.
 * Takes care of adding panels, sections & fields to the customizer.
 * For documentation please see https://github.com/aristath/xtkirki/wiki
 *
 * @package     XTKirki
 * @category    Core
...
if ( ! class_exists( 'XTKirki' ) ) {
	 ...
	 */
	class XTKirki extends XTKirki_Init {

		/**
		 * Absolute path to the XTKirki folder.
		 *
		 * @static
		 * @access public
		 * @var string
		...
		public static function get_option( $config_id = '', $field_id = '' ) {
			...
			return XTKirki_Values::get_value( $config_id, $field_id );
		...
		public static function add_config( $config_id, $args = array() ) {
			...
			$config = XTKirki_Config::get_instance( $config_id, $args );
		...
		public static function add_panel( $id = '', $args = array() ) {
			...
			$args['type']        = 'xtkirki-' . $args['type'];
			if ( ! isset( $args['active_callback'] ) ) {
				$args['active_callback'] = ( isset( $args['required'] ) ) ? array( 'XTKirki_Active_Callback', 'evaluate' ) : '__return_true';
			}
		...
		public static function add_field( $config_id, $args ) {
			...
			if ( isset( $args['type'] ) ) {
				...
				$classname = 'XTKirki_Field_' . str_replace( ' ', '_', ucwords( $str ) );
			...
			new XTKirki_Field( $config_id, $args );
