...
if ( ! class_exists( 'XTKirki_Sanitize_Values' ) ) {

	/**
	 * A simple wrapper class for static methods.
	 */
	class XTKirki_Sanitize_Values {
		...
		public static function __callStatic( $name, $arguments ) {
			error_log( "XTKirki_Sanitize_Values::$name does not exist" );
			return $arguments;
		}
		 ...
		 *
		 * Deprecated. Use XTKirki_Field_Checkbox::sanitize() instead.
		 *
		 * @static
		 * @access public
		 * @see XTKirki_Field_Checkbox::sanitize()
		 * @param bool|string $value Whether the checkbox is checked.
		 * @return bool Whether the checkbox is checked.
		 */
		public static function checkbox( $value ) {
			return XTKirki_Field_Checkbox::sanitize( $value );
		}
