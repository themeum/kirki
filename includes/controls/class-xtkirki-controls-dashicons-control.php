...
if ( ! class_exists( 'XTKirki_Controls_Dashicons_Control' ) ) {

	/**
	 * Dashicons control (modified radio).
	 */
	class XTKirki_Controls_Dashicons_Control extends XTKirki_Customize_Control {
		...
		public function to_json() {
			parent::to_json();
			$this->json['icons'] = XTKirki_Helper::get_dashicons();
		}
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-dashicons' );
		}
