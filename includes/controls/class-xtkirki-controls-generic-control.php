<?php
/**
 * Customizer Control: xtkirki-generic.
 *
 * @package     XTKirki
 * @subpackage  Controls
...
if ( ! class_exists( 'XTKirki_Controls_Generic_Control' ) ) {

	/**
	 * A generic and pretty abstract control.
	 * Allows for great manipulation using the field's "choices" argumnent.
	 */
	class XTKirki_Controls_Generic_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-generic' );
		}
