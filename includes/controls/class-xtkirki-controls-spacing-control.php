...
if ( ! class_exists( 'XTKirki_Controls_Spacing_Control' ) ) {

	/**
	 * Spacing control.
	 * multiple checkboxes with CSS units validation.
	 */
	class XTKirki_Controls_Spacing_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-spacing' );
		}
