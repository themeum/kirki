<?php
/**
 * Customizer Control: xtkirki-radio.
 *
 * @package     XTKirki
 * @subpackage  Controls
...
if ( ! class_exists( 'XTKirki_Controls_Radio_Control' ) ) {

	/**
	 * Radio control
	 */
	class XTKirki_Controls_Radio_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-radio' );
		}
