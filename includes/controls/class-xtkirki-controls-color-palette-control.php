...
if ( ! class_exists( 'XTKirki_Controls_Color_Palette_Control' ) ) {

	/**
	 * Adds a color-palette control.
	 * This is essentially a radio control, styled as a palette.
	 */
	class XTKirki_Controls_Color_Palette_Control extends XTKirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'xtkirki-color-palette';
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-color-palette' );
		}
		...
		public function to_json() {
			...
			if ( ! isset( $this->json['choices']['colors'] ) || empty( $this->json['choices']['colors'] ) ) {
				$this->json['choices']['colors'] = XTKirki_Helper::get_material_design_colors( 'primary' );
			}
