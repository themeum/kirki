...
if ( ! class_exists( 'XTKirki_Controls_Repeater_Control' ) ) {

	/**
	 * Repeater control
	 */
	class XTKirki_Controls_Repeater_Control extends XTKirki_Customize_Control {
			...
			if ( is_array( $this->fields ) && ! empty( $this->fields ) ) {
				...
				foreach ( $this->fields as $field ) {
					if ( isset( $field['type'] ) && 'dropdown-pages' === $field['type'] ) {
						wp_enqueue_script( 'xtkirki-dropdown-pages' );
						break;
					}
				}
			}

			wp_enqueue_script( 'xtkirki-repeater' );
		}
		...
		public function repeater_js_template() {
			...
			<script type="text/html" class="customize-control-repeater-content">
				...
				<# data.xtkirki_config = '<?php echo esc_attr( $this->xtkirki_config ); ?>'; #>
						...
						<# _.each( data, function( field, i ) { #>
							...
							<div class="repeater-field repeater-field-{{{ field.type }}}">
								...
								<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
									...
									<figure class="xtkirki-image-attachment" data-placeholder="<?php echo esc_attr( $this->l10n['no-image-selected'] ); ?>" >
										<# if ( field.default ) { #>
								...
								<# } else if ( field.type === 'upload' ) { #>
									...
									<figure class="xtkirki-file-attachment" data-placeholder="<?php echo esc_attr( $this->l10n['no-file-selected'] ); ?>" >
										<# if ( field.default ) { #>
