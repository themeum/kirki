...
if ( ! class_exists( 'XTKirki_Controls_Preset_Control' ) ) {

	/**
	 * Preset control (modified select).
	 */
	class XTKirki_Controls_Preset_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-preset' );
		}
