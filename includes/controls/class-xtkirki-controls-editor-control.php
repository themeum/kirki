...
if ( ! class_exists( 'XTKirki_Controls_Editor_Control' ) ) {

	/**
	 * A TinyMCE control.
	 */
	class XTKirki_Controls_Editor_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-editor' );
		}
		 ...
		 *
		 * The actual editor is added from the XTKirki_Field_Editor class.
