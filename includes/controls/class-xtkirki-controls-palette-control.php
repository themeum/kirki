...
if ( ! class_exists( 'XTKirki_Controls_Palette_Control' ) ) {

	/**
	 * Palette control (modified radio).
	 */
	class XTKirki_Controls_Palette_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-palette' );
		}
