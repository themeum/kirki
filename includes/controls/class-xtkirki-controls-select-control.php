<?php
/**
 * Customizer Control: xtkirki-select.
 *
 * @package     XTKirki
 * @subpackage  Controls
...
if ( ! class_exists( 'XTKirki_Controls_Select_Control' ) ) {

	/**
	 * Select control.
	 */
	class XTKirki_Controls_Select_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-select' );
		}
