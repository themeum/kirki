...
if ( ! class_exists( 'Kirki_Controls_Dropdown_Categories_Control' ) ) {
	 ...
	 */
	class Kirki_Controls_Dropdown_Categories_Control extends Kirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'kirki-dropdown-categories';
		...
		public function to_json() {
			...
			$dropdown = wp_dropdown_categories(
				array(
					...
					'echo'              => 0,
					'show_option_none'  => esc_attr( $l10n['select-category'] ),
					'option_none_value' => '0',
