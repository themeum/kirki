...
if ( ! class_exists( 'XTKirki_Controls_Dropdown_Pages_Control' ) ) {
	 ...
	 */
	class XTKirki_Controls_Dropdown_Pages_Control extends XTKirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'xtkirki-dropdown-pages';
