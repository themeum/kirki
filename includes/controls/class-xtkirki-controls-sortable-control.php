...
if ( ! class_exists( 'XTKirki_Controls_Sortable_Control' ) ) {

	/**
	 * Sortable control (uses checkboxes).
	 */
	class XTKirki_Controls_Sortable_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-sortable' );
		}
				...
				<ul class="sortable">
					<# for ( i in data.filteredValues ) { #>
						<# if ( data.filteredValues.hasOwnProperty( i ) ) { #>
							<li {{{ data.inputAttrs }}} class='xtkirki-sortable-item' data-value='{{ data.filteredValues[i] }}'>
					...
					<# for ( i in data.invisibleKeys ) { #>
						<# if ( data.invisibleKeys.hasOwnProperty( i ) ) { #>
							<li {{{ data.inputAttrs }}} class='xtkirki-sortable-item invisible' data-value='{{ data.invisibleKeys[i] }}'>
								<i class='dashicons dashicons-menu'></i>
								<i class="dashicons dashicons-visibility visibility"></i>
