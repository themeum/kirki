...
if ( ! class_exists( 'XTKirki_Controls_Radio_Image_Control' ) ) {

	/**
	 * Radio Image control (modified radio).
	 */
	class XTKirki_Controls_Radio_Image_Control extends XTKirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'xtkirki-radio-image';
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-radio-image' );
		}
