...
if ( ! class_exists( 'XTKirki_Controls_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class XTKirki_Controls_Slider_Control extends XTKirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-slider' );
		}
		...
		protected function content_template() {
			...
			<label>
				...
				<div class="wrapper">
					...
					<div class="xtkirki_range_value">
						<span class="value">{{ data.value }}</span>
						<# if ( data.choices['suffix'] ) { #>
							{{ data.choices['suffix'] }}
						<# } #>
					</div>
					<div class="xtkirki-slider-reset">
