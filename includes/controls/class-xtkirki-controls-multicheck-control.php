...
if ( ! class_exists( 'XTKirki_Controls_MultiCheck_Control' ) ) {

	/**
	 * Adds a multicheck control.
	 */
	class XTKirki_Controls_MultiCheck_Control extends XTKirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'xtkirki-multicheck';
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-multicheck' );
		}
