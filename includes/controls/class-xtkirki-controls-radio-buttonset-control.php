...
if ( ! class_exists( 'XTKirki_Controls_Radio_Buttonset_Control' ) ) {

	/**
	 * Radio Buttonset control (modified radio)
	 */
	class XTKirki_Controls_Radio_Buttonset_Control extends XTKirki_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'xtkirki-radio-buttonset';
		...
		public function enqueue() {
			wp_enqueue_script( 'xtkirki-radio-buttonset' );
		}
