...
if ( ! class_exists( 'XTKirki_Settings' ) ) {

	/**
	 * Each setting is a separate instance
	 */
	class XTKirki_Settings {
		...
		/**
		 * Creates a new XTKirki_Settings object.
		 * Class constructor.
		 *
		 * @access public
		 ...
		 * Makes sure the xtkirki/setting_types filter is applied
		...
		final private function set_setting_types() {
			...
			// Apply the xtkirki/setting_types filter.
			$this->setting_types = apply_filters( 'xtkirki/setting_types', array(
				'default'  => 'XTKirki_Settings_Default_Setting',
				'repeater' => 'XTKirki_Settings_Repeater_Setting',
			) );
