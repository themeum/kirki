 ...
 */
$sections = [
	'background'      => [ esc_html__( 'Background', 'kirki' ), '', 'outer' ],
	'code'            => [ esc_html__( 'Code', 'kirki' ), '', 'outer' ],
	'checkbox'        => [ esc_html__( 'Checkbox', 'kirki' ), '', 'outer' ],
	'color'           => [ esc_html__( 'Color', 'kirki' ), '', 'outer' ],
	'color-palette'   => [ esc_html__( 'Color Palette', 'kirki' ), '', 'outer' ],
	'custom'          => [ esc_html__( 'Custom', 'kirki' ), '', 'outer' ],
	'dashicons'       => [ esc_html__( 'Dashicons', 'kirki' ), '', 'outer' ],
	'date'            => [ esc_html__( 'Date', 'kirki' ), '', 'outer' ],
	'dimension'       => [ esc_html__( 'Dimension', 'kirki' ), '', 'outer' ],
	'dimensions'      => [ esc_html__( 'Dimensions', 'kirki' ), '', 'outer' ],
	'dropdown-pages'  => [ esc_html__( 'Dropdown Pages', 'kirki' ), '', 'outer' ],
	'editor'          => [ esc_html__( 'Editor', 'kirki' ), '', 'outer' ],
	'fontawesome'     => [ esc_html__( 'Font-Awesome', 'kirki' ), '', 'outer' ],
	'generic'         => [ esc_html__( 'Generic', 'kirki' ), '', 'outer' ],
	'image'           => [ esc_html__( 'Image', 'kirki' ), '', 'outer' ],
	'multicheck'      => [ esc_html__( 'Multicheck', 'kirki' ), '', 'outer' ],
	'multicolor'      => [ esc_html__( 'Multicolor', 'kirki' ), '', 'outer' ],
	'number'          => [ esc_html__( 'Number', 'kirki' ), '', 'outer' ],
	'palette'         => [ esc_html__( 'Palette', 'kirki' ), '', 'outer' ],
	'preset'          => [ esc_html__( 'Preset', 'kirki' ), '', 'outer' ],
	...
	'repeater'        => [ esc_html__( 'Repeater', 'kirki' ), '', 'outer' ],
	'select'          => [ esc_html__( 'Select', 'kirki' ), '', 'outer' ],
	'slider'          => [ esc_html__( 'Slider', 'kirki' ), '', 'outer' ],
	'sortable'        => [ esc_html__( 'Sortable', 'kirki' ), '', 'outer' ],
