...
class Kirki_Field_Color_Gradient extends Kirki_Field {
	...
	public static function sanitize( $value ) {
		...
		return array(
			'color1'       => ( isset( $value['color1'] ) ) ? esc_attr( $value['color1'] ) : '',
			'color2'       => ( isset( $value['color2'] ) ) ? esc_attr( $value['color2'] ) : '',
			'location'     => ( isset( $value['location'] ) ) ? esc_attr( $value['location'] ) : '',
			'direction'    => ( isset( $value['direction'] ) ) ? esc_attr( $value['direction'] ) : '',
		);
	}
