 ...
 * Field overrides.
 */
class Kirki_Field_Box_Shadow extends Kirki_Field {
	...
	public static function sanitize( $value ) {
		...
		return array(
			'h_offset' => ( isset( $value['h_offset'] ) ) ? esc_attr ( $value['h_offset'] ) : '0px',
			'v_offset' => ( isset( $value['v_offset'] ) ) ? esc_attr( $value['v_offset'] ) : '0px',
			'blur'     => ( isset( $value['blur'] ) ) ? esc_attr( $value['blur'] ) : '0px',
			'spread'   => ( isset( $value['spread'] ) ) ? esc_attr( $value['spread'] ) : '0px',
