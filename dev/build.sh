...
find customizer/packages -type f -name "*.map" -delete
...
find customizer/packages -type f \( -name "LICENSE" -o -name "package.json" -o -name ".gitignore" -o -name "Gruntfile.js" \) -delete
...
find customizer/packages -type f -path "*/src/*" \( -name "*.ts" -o -name "*.tsx" \) -delete 2>/dev/null || true

# Remove SCSS source files (compiled to dist/)
find customizer/packages -type f -path "*/src/*" \( -name "*.scss" -o -name "*.sass" \) -delete 2>/dev/null || true
...
find customizer/packages/controls -type f -path "*/src/*.js" ! -path "*/compatibility/*" -delete 2>/dev/null || true
find customizer/packages/fields -type f -path "*/src/*.js" -delete 2>/dev/null || true
find customizer/packages/modules -type f -path "*/src/*.js" ! -path "*/modules/webfonts/src/assets/scripts/vendor-typekit/webfontloader.js" -delete 2>/dev/null || true
...
rm -rf customizer/packages/compatibility/src/scripts 2>/dev/null || true
rm -f customizer/packages/compatibility/src/Scripts.php 2>/dev/null || true
...
rm -f customizer/packages/utils/googlefonts/src/webfont-files.json 2>/dev/null || true

# Remove webfonts vendor source files (webfontloader.js is the compiled version, source files not needed)
find customizer/packages/modules/webfonts/src/assets/scripts/vendor-typekit/src -type f -delete 2>/dev/null || true
find customizer/packages/modules/webfonts/src/assets/scripts/vendor-typekit -type d -name "src" -exec rm -rf {} + 2>/dev/null || true
find customizer/packages/modules/webfonts/src/assets/scripts/vendor-typekit -type f -name "*.yml" -delete 2>/dev/null || true
